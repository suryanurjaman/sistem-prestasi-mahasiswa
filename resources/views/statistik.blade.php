            ...
            <ul class="flex flex-wrap -mb-px text-sm font-medium text-center" id="default-styled-tab"
                ...
                <li class="me-2" role="presentation">
                    <button class="inline-block p-4 border-b-2 rounded-t-lg" id="dashboard-tab"
                        ...
                        aria-selected="false">Prodi</button>
                </li>
                <li class="me-2" role="presentation">
...
@push('scripts')
    <script>
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            makeBarChart(
                'chartFakultas',
                Object.keys(fakultasData),
                Object.values(fakultasData),
                'Jumlah Prestasi'
            );
            ...
            makeBarChart(
                'chartProdi',
                Object.keys(prodiData),
                Object.values(prodiData),
                'Jumlah Prestasi'
            );
            ...
            makeBarChart(
                'chartOrmawa',
                Object.keys(ormawaData),
                Object.values(ormawaData),
                'Jumlah Prestasi'
            );
            ...
            makeBarChart(
                'chartTahun',
                Object.keys(tahunData),
                Object.values(tahunData),
                'Jumlah Prestasi'
            );
